...
export const UsersGroupIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
...
export const CakeIcon = ({ className = "w-6 h-6" }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M20 21v-8a4 4 0 0 0-4-4H8a4 4 0 0 0-4 4v8"></path><path d="M4 16h16"></path><path d="M12 4.5c-2 0-3.5-2-3.5-4h7c0 2-1.5 4-3.5 4z"></path></svg>
);
